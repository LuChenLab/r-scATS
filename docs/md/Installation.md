...
In addition, we provide installation logs for three successful installation methods to ensure full reproducibility in <a href="https://github.com/LuChenLab/r-scATS/tree/main/logs">here</a>.
