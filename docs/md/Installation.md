...
In addition, we provide installation <a href="https://github.com/LuChenLab/r-scATS/tree/main/logs">logs</a> for three successful installation methods to ensure full reproducibility.
